...
<body>
     ...
     <nav class="navbar navbar-inverse" role="navigation">
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <?php include "web/panier.php";?>

                 <a href="index.php?detail_panier"><i class="glyphicon glyphicon-shopping-cart marger_topicon" style="float:right" aria-hidden="true"></i></a>
    ...
    <div class="container marge_top_section">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
               <!--Menu categorie-->
               <?php include "web/menu_categorie.php";?>
                <div class="menu_box">
                    <h3 class="menu_head">CATALOGUE</h3>
				   	     <ul class="nav_color">
                     <a href="web/homme.php" class="list-group-item">Homme</a>
                    <a href="web/femme.php" class="list-group-item">Femme</a>
                    <a href="web/enfant.php" class="list-group-item">Enfant</a>
...
-->
    ...
    {
          include "web/detail_panier.php";
    }
    else
    {

        include "web/produits.php";
    }
    ?>
  ...
  <div class="col-sm-4">
            ...
            for($i=1;$i<=$nbr_page;$i++)
            {
				...
				{?>
                <a href="index.php?categorie=<?php echo $recuper_cat?>&num_page=<?php echo $i?>">
                <?php
                }
				else
				{
					?>
                <a href="index.php?num_page=<?php echo $i?>">
                <?php
					}
            ?>
