...
{
	$recuper_cat=$_GET['Catalogue'];
	$requete="SELECT * FROM `produits` where `Catalogue`= '$recuper_cat'";
}
else
{
$requete="SELECT * FROM `produits` where `Catalogue`='enfant'";
}
     ...
     <div class="col-sm-3 col-lg-3 col-md-3">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <h5><a href="promotion.php?detail=<?php echo $ligne['ref']?>"><?php echo $ligne['nom']?></a>
                                </h5>
